...
export default function Contact() {
	return (
		<>
			<section
				id="contact"
				className="overflow-hidden h-full w-[90%] mx-auto flex flex-col justify-center items-center pt-10 md:pt-0">
				<div className="shadow-xl p-3 rounded-xl bg-white/20 backdrop-blur-md border border-white/30">
