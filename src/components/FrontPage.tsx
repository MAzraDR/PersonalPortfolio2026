		...
		<>
			<div id="home" className="h-full w-screen flex flex-col justify-center items-center">
				<div className="text-center md:text-left">
					...
					<button  className="mt-5 md:mt-2 mx-auto md:mx-0 block bg-mainAccent rounded-2xl px-10 py-2 text-white font-semibold uppercase text-base cursor-pointer active:scale-80 transition-all duration-300">
						Get started
					</button>
				</div>
			</div>
